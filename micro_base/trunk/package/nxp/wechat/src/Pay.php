...
use App\Model\WxPayOrder;
use App\Repository\CommCodeMasterRepo;
...
class Pay
{
    ...
    public function __construct(CommCodeMasterRepo $repo)
    {
...
//  公共账号
    ...
    {
        $ret =  $this->repo->getConfigure('wxconfig_open_platform','wx');
        $appid = $ret['property2'];
...
//  交易类型
    ...
    {
        $trade_type = config('parameter.WE_CHAT.tradeType');
