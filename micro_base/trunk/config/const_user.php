...
return [
    ...
    'AGENT_USER' => array('code' => 'P1301', 'msg' => '创客'),
    ...
    'P1301' => array('field' => '', 'code' => R('webimg/userLevel/P1301.png'), 'msg' => '创客', 'amount' => 10000.00, 'levelAmount' => 0),
    ...
    'P1601' => array('field' => '', 'code' => R('webimg/userLevel/P1601.png'), 'msg' => '代理商', 'amount' => 1000000.00, 'levelAmount' => 0),

    'P2101' => array('field' => '', 'code' => R('webimg/userLevel/P2101.png'), 'msg' => '运营中心', 'amount' => 6000.00),
    ...
    //乘客下单状态
    'passenger_status' => [
        'no_trip' => '0010',//未下单,没有行程
        'dispatch' => '0020',//已下单调度中
        'in_trip' => '0030',//行程中
    ]
];