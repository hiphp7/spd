...
class Validation extends Validator{
    ...
    */
    ...
    {
        if($data){
            return preg_match('/^1[3456789]\d{1}\d{8}$/', $data);
        }
        return '';
    }
     ...
     * @return bool
     */
    public function ValidateNumber($translator, $data, $rules, $messages)
    {
     ...
     * @return false|int
     */
    public function ValidateUserName($translator, $data, $rules, $messages)
    {
        if($data) {
            return preg_match('/^[A-Za-z0-9_\x{4e00}-\x{9fa5}]{1,11}+$/u',$data);
        }
        return $data;
    }
}