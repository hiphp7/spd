...
return [
    ...
    */
    'server' => [
        'host' => env('SWOOLE_TCP_HOST', '0.0.0.0'),
        'port' => env('SWOOLE_TCP_PORT', '9501'),
        'public_path' => base_path('public'),
        // Determine if to use swoole to respond request for static files
        'handle_static_files' => env('SWOOLE_HANDLE_STATIC', true),
        'access_log' => env('SWOOLE_TCP_ACCESS_LOG', false),
        // You must add --enable-openssl while compiling Swoole
        // Put `SWOOLE_SOCK_TCP | SWOOLE_SSL` if you want to enable SSL
        'socket_type' => SWOOLE_SOCK_TCP,
        'process_type' => SWOOLE_PROCESS,
        'options' => [
            'pid_file' => env('SWOOLE_TCP_PID_FILE', base_path('storage/logs/swoole_tcp.pid')),
            'log_file' => env('SWOOLE_TCP_LOG_FILE', base_path('storage/logs/swoole_tcp.log')),
            'daemonize' => env('SWOOLE_TCP_DAEMONIZE', false),
            // Normally this value should be 1~4 times larger according to your cpu cores.
            'reactor_num' => env('SWOOLE_TCP_REACTOR_NUM', swoole_cpu_num()),
            'worker_num' => env('SWOOLE_TCP_WORKER_NUM', swoole_cpu_num()),
            'task_worker_num' => env('SWOOLE_TCP_TASK_WORKER_NUM', swoole_cpu_num()),
    ...
    */
    'tables' => [
        'table' => [
            'size' => 1024,
            'columns' => [
                ['name' => 'data', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 1024],
            ]
        ],
    ],
];
